...
I'm a passionate **Full Stack Developer** with expertise in creating efficient, scalable web applications. I specialize in **Backend** and **DevOps**, focusing on clean architecture, SOLID principles, and best development practices.

- 🌍 **Location:** Guatemala
- 💼 **Focus:** Backend Development, Web APIs, Database Design, Cloud Solutions
- 🎯 **Specialization:** Python, TypeScript, RESTful APIs, AWS
...
![RESTful API](https://img.shields.io/badge/RESTful_API-FF6C37?style=for-the-badge&logo=rest&logoColor=white)
...
![Cloudinary](https://img.shields.io/badge/Cloudinary-3C99DC?style=for-the-badge&logo=cloudinary&logoColor=white)
...
![pip](https://img.shields.io/badge/pip-000000?style=for-the-badge&logo=pypi&logoColor=white)
![UV](https://img.shields.io/badge/UV-1AB7EA?style=for-the-badge&logo=uv&logoColor=white)
...
![Perplexity AI](https://img.shields.io/badge/Perplexity_AI-000000?style=for-the-badge&logo=perplexity&logoColor=white)
...
![Lovabe](https://img.shields.io/badge/Lovabe-000000?style=for-the-badge&logo=lovabe&logoColor=white)
...
- **🏗️ Backend Architecture:** Design and implement scalable backend systems using Django, FastAPI, Flask, Node.js and Next.js
- **🔗 API Development:** Create robust RESTful APIs with JWT and OAuth2 authentication
- **💾 Database Design:** Optimize database structures and queries (PostgreSQL, MySQL, Oracle, MongoDB)
...
- **🎨 Frontend Development:** Build responsive interfaces with Vue.js, React, and modern CSS frameworks
- **☁️ Cloud Solutions:** Deploy and manage applications on AWS infrastructure, leveraging services like EC2, S3, RDS, and Lambda
- **🐳 DevOps Practices:** Implement CI/CD pipelines with GitHub Actions and Jenkins
- **📋 Agile Methodology:** Work with SCRUM and agile practices for efficient project delivery
...
[![Portfolio](https://img.shields.io/badge/Portfolio-000000?style=for-the-badge&logo=googlechrome&logoColor=white)](https://josecode.dev)
